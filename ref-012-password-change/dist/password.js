...
/* source: ref-012-password-change/js/data.js */
const passwordUsers = {
...
/* source: ref-012-password-change/js/state.js */
...
/* source: ref-012-password-change/js/ui.js */
...
/* source: ref-012-password-change/js/password.js */
...
/* source: ref-012-password-change/js/main.js */
...
if (state.authType === "Passport") {
  ...
  refs.current.value = state.user.currentPassword || "";
  updateAccount(refs, state.user);
