...
export function filterAssignmentOptions(input, picker) {
...
export function updateAssignmentTags(picker, selectedContainer) {
...
export function removeAssignment(event) {
...
export function openRoles(index, mode = "edit") {
