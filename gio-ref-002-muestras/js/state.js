...
export const state = { filteredSamples: [...samples], editingIndex: null, openMenu: null, step: 1, dirty: false, pendingAction: null, pendingStatus: null, pendingCancel: false, pendingWizardStep: null, replacementSelection: null, replacementCandidate: null, draft: null };
...
export function resetWizard() { state.editingIndex = null; state.openMenu = null; state.step = 1; state.dirty = false; state.pendingAction = null; state.pendingStatus = null; state.pendingCancel = false; state.pendingWizardStep = null; state.replacementSelection = null; state.replacementCandidate = null; state.draft = null; }
